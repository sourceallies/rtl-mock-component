...
it('should throw an exception if the component is not a mock', () => {
    ...
    try {
        ...
        expect(err.message).toEqual("MockedComponent cannot be setup because it is not a compatable mock. Call \"jest.mock('path/to/component')\" or \"vi.mock('path/to/component')\" first");
    }
});